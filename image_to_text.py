...
class Application():
    ...
    def takeBoundedScreenShot(self, x1, y1, x2, y2):
        ...
        im.save(".imagetotext_temp" + ".png")

    def drawRectangle(self):
        self.master_screen.deiconify()
        root.withdraw()

        self.screenCanvas = Canvas(self.picture_frame, cursor="cross", bg="red")
    ...
    def on_button_press(self, event):
        ...
        self.rect = self.screenCanvas.create_rectangle(self.x, self.y, 1, 1)
...
def processImageToText(image_path):
    # process image using tesseract
    text = pytesseract.image_to_string(Image.open(image_path), lang="eng")
    # post-processing - remove lines that only contain whitespace
...
if __name__ == '__main__':
    ...
    processImageToText('.imagetotext_temp.png')